...
<?= $this->section('title') ?> - マイページ - 受け取ったコメント<?= $this->endSection() ?>
...
<main class="container">
	...
	<div class="border border-top-0 rounded-bottom p-2">
		<ul class="nav nav-pills mb-3">
			<li class="nav-item">
				<a class="nav-link" href="<?= site_url('mypage/comment_posted') ?>">投稿したコメント</a>
			</li>
			<li class="nav-item">
				<a class="nav-link active" aria-current="page" href="<?= site_url('mypage/comment_received') ?>">受け取ったコメント</a>
			</li>
		</ul>
		<h4 class="h4 fw-normal">受け取ったコメント</h4>
		<div style="font-size: 85%;">作品ページへ行くには投稿日をクリック/タップしてください。<br>非公開のプロンプトの場合は編集ページが開きます。<br>コメント削除は作品ページから行ってください。<br></div>
