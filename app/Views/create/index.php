						...
						<div class="row mb-3">
							...
							<div class="col-md-11">
								<select class="form-control" id="script[<?= $i ?>][type]" name="script[<?= $i ?>][type]" disabled>
									...
									<option value="script_in_pin_user" <?= set_select('script[' . $i . '][type]', 'script_in_pin_user', isset($post_data['script'][$i]['type']) ? ($post_data['script'][$i]['type'] === 'script_in_pin_user') : false) ?>>発言欄の置換</option>
									...
									<option value="script_in_pin_user_regex" <?= set_select('script[' . $i . '][type]', 'script_in_pin_user_regex', isset($post_data['script'][$i]['type']) ? ($post_data['script'][$i]['type'] === 'script_in_pin_user_regex') : false) ?>>発言欄の置換（正規表現）</option>
			...
			<div class="border rounded accordion-item mb-3">
				...
				<div id="parameters-body" class="accordion-collapse collapse p-3" aria-labelledby="parameters-head">
					...
					<div class="row">
						...
						<div class="col-lg-3 col-sm-6 mt-2">
							<input class="btn-check" type="checkbox" value="1" id="gui_mode" name="gui_mode" <?= set_checkbox('gui_mode', '1', isset($post_data['gui_mode']) ? ($post_data['gui_mode'] === '1') : false) ?> autocomplete="off">
						...
						<div class="col-lg-3 col-sm-6 mt-2">
							<input class="btn-check" type="checkbox" value="1" id="chat_auto_enter" name="chat_auto_enter" <?= set_checkbox('chat_auto_enter', '1', isset($post_data['chat_auto_enter']) ? ($post_data['chat_auto_enter'] === '1') : false) ?> autocomplete="off">
						...
						<div class="col-lg-3 col-sm-6 mt-2">
							<input class="btn-check" type="checkbox" value="1" id="chat_auto_brackets" name="chat_auto_brackets" <?= set_checkbox('chat_auto_brackets', '1', isset($post_data['chat_auto_brackets']) ? ($post_data['chat_auto_brackets'] === '1') : false) ?> autocomplete="off">
