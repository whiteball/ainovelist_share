				...
				<div id="parameters-body" class="accordion-collapse collapse p-3" aria-labelledby="parameters-head">
					<div id="parameters" class="row">
						...
						<div class="col-12 col-lg-6 col-xxl-4">
							...
							<div class="row">
								<div class="col-10 col-lg-9"><input type="range" class="form-range" id="contextwindow" name="contextwindow" min="38" max="4096" value="<?= set_value('contextwindow', $post_data['contextwindow'] ?? '256') ?>"></div>
