...
<main class="container">
	...
	<div>
		...
		<ul>
			...
			<li>@endpointがある場合は、「続きの文を書く」「リトライ」したときに@endpointの前にスクロールするようにし、「続きの文を書く」「リトライ」「Undo」「Redo」したときに@endpointの前にスクロールするようにする。</li>
			...
			<li>オプションの右端のアイコン(iのマーク)を押すと、編集ページを開いてからの出力回数などの統計情報を確認出来るエリアを表示する。。</li>
			<li>環境設定に「オプションアイコンを横スクロール可能にする」「@endpointがあっても挿入位置を常に一番下にする」の設定を追加する。</li>
		</ul>
	</div>
	<hr>
	<h4>導入手順</h4>
